...
export default class AddProfileStatus extends Component {
  constructor(props) {
    super(props);
    this.state = {
      title: "Add Profile Status"
    };
  }
  render() {
    return (
        ...
        <div className="row">
          ...
          >
            ...
            <ul className="breadcrumb">
              ...
              <li>
                <a href="/master/ProfileStatus">Profile Status</a>
              </li>
              <li>Add Profile Status</li>
            </ul>
            <div style={{ marginTop: "20px", marginLeft: "50px" }}>
              <NavLink to="/master/ProfileStatus">
                <button
                  type="button"
