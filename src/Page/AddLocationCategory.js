...
export default class AddLocationCategory extends Component {
  constructor(props) {
    super(props);
    this.state = {
        ...
        <div className="row">
          ...
          >
            ...
            <ul className="breadcrumb">
              ...
              <li>
                <a href="/master/PreferredLocationCategory">
                  Location Category
                </a>
              </li>
              <li>Add Location Category</li>
            </ul>
            <div style={{ marginTop: "20px", marginLeft: "50px" }}>
              <NavLink to="/master/PreferredLocationCategory">
                <button
                  type="button"
            ...
            >
              ...
              >
                <div className="container">
                  <form action="#">
                    <h3>Add Location Category</h3>
                    <div className="form-group">
                      <input
                        type="text"
                        className="form-control"
                        placeholder="Enter The Location Category"
                        name="text1"
                      />
                    </div>
