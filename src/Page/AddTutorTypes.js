...
export default class AddTutorTypes extends Component {
  constructor(props) {
    super(props);
    this.state = {
      title: "Add Tutor Types"
    };
  }
  render() {
    return (
        ...
        <div className="row">
          ...
          >
            ...
            <ul className="breadcrumb">
              ...
              <li>
                <a href="/master/TutorTypes">Tutor Types</a>
              </li>
              <li>Add Tutor Types</li>
            </ul>
            <div style={{ marginTop: "20px", marginLeft: "50px" }}>
              <NavLink to="/master/TutorTypes">
                <button
                  type="button"
            ...
            >
              ...
              >
                <div className="container">
                  <form action="#">
                    <h3>Add Tutor Types</h3>
                    <div className="form-group">
                      <input
                        type="text"
                        className="form-control"
                        placeholder="Enter The Tutor Type"
                        name="text1"
                      />
                    </div>
