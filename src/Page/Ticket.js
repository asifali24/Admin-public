  ...
  render() {
    const ticket = [
      ...
      },
      {
        ...
        Description:
          "xfguiyftccyguhiyyt xrfgyuuxtygfcr6tyyj gtdsxdcfygvyubytcyrtxezteSzdxtcfy crvytcftucgvuicyrr crtyfytrtcfgv8rcgfiyg rtfyyfftfyfyctiufyiglutixyrfcguygi;yutiyrxxxxxxxxxxxxxxxxxxxxxxxxxxxxx xexturdytfuttttt rdyf"
      },
      {
        id: "03",
        date: "06/07/2019",
        title: "i want to delete the session",
        Description:
          "rvytcftucgvuicyrr crtyfytrtcfgv8rcgfiyg rtfyyfftfyfyctiufyiglutixyrfcguygi;yutiyrxxxxxxxxxxxxxxxxxxxxxxxxxxxxx xexturdytfuttttt rdyf"
      },
      {
        id: "04",
        date: "06/07/2019",
    ...
    const ticketList = ticket.map(tickets => (
      <tr className="col" style={{ textAlign: "center" }} key={tickets.id}>
        <td>{tickets.id}</td>
        <td>{tickets.date}</td>
        <td>{tickets.title}</td>
